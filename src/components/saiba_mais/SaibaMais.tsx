  ...
  return (
    <section className="container mx-auto pb-16 pt-10">
      <div className="flex flex-col items-center">
        <h1 className="mb-5 text-5xl text-[#373737]">Quer saber mais?</h1>
        <Link href="https://api.whatsapp.com/send/?phone=553138912160&text=Ol%C3%A1%2C+gostaria+de+saber+mais+informa%C3%A7%C3%B5es+sobre+o+clube+do+botox&type=phone_number&app_absent=0">
          <button
            className={`flex w-60 items-center justify-between rounded-full bg-gradient-to-r from-zinc-300 to-black text-white ${openSans.className} pr-4`}
          >
            <Image
              alt="soninha"
              src={soninha}
      ...
      >
        <div className="flex flex-col items-center sm:items-start">
          <h2 className="mb-7 text-4xl font-bold">Endereços</h2>
        ...
        <div>
          <div className="mb-10 text-center">
            <h2 className="mb-7 text-4xl font-bold">Contatos</h2>
            <Link
            ...
            >
              <Phone className="mr-3 h-7 w-7" /> (31) 3891-2160
            </Link>
          </div>
          <div>
            <h2 className="mb-7 text-4xl font-bold">Acompanhe</h2>
